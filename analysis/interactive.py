...
from analysis.load_and_clean import load_and_clean
tmp_df2 = load_and_clean('daily')
...
tmp_df4['pct_chg6_std'] = tmp_df4.pct_chg6 / tmp_df4.std_pc
...
tmp_df4_reg[['pct_chg1','pct_chg2', 'pct_chg3', 'pct_chg4','pct_chg5','pct_chg6']].fillna(0, inplace=True)
tmp_df4_reg[['pct_chg1_std','pct_chg2_std', 'pct_chg3_std', 'pct_chg4_std','pct_chg5_std','pct_chg6_std']].fillna(0, inplace=True)

foo = reg.fit( tmp_df4_reg[['pct_chg2', 'pct_chg3', 'pct_chg4']], tmp_df4_reg['pct_chg1'])

foo = reg.fit( tmp_df4_reg[['pct_chg2_std', 'pct_chg3_std', 'pct_chg4_std']], tmp_df4_reg['pct_chg1_std'])
foo.coef_

foo = reg.fit( tmp_df4_reg[['pct_chg2_std', 'pct_chg3_std', 'pct_chg4_std','pct_chg5_std','pct_chg6_std']], tmp_df4_reg['pct_chg1_std'])
foo.coef_
